...
def run_real_time_model(ticker, price_window=1000, div_window=20):
    ...
    calibrated_price_clf = CalibratedClassifierCV(
        RandomForestClassifier(n_estimators=100, max_depth=10, min_samples_split=10, random_state=1, n_jobs=1),
        method='isotonic', 
        cv=5,
        n_jobs=1
    )
    ...
    price_reg = RandomForestRegressor(n_estimators=100, max_depth=10, min_samples_split=10, random_state=1, n_jobs=1)
