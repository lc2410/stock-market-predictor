    ...
    for benchmark in benchmarks_list:
        ...
        for ticker in benchmark_tickers:
            if ticker in stock_metrics:
                ...
                # Find the original constituent object and inject the computed metrics
                constituent_obj = next((constituent for constituent in benchmark["constituents"] if constituent["symbol"] == ticker), None)
                if constituent_obj:
        ...
        scans_by_benchmark[benchmark_name] = benchmark_scans
        movers_by_benchmark[benchmark_name] = benchmark_movers
